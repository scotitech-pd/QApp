...
export function validateBusinessSignupInput(payload: unknown) {
  ...
  const normalized: NormalizedBusinessSignupInput = {
    ...
    countryCode: normalizeString(String(input.countryCode)).toUpperCase(),
    industryType,
